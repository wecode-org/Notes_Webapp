...
<div class="dropdown">
  <button onclick="myFunction()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">ALGEBRA AND NUMBER THEORY</button>
...
<div class="dropdown">
  <button onclick="myFunctiontwo()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> COMPUTER NETWORKS</button>
...
<div class="dropdown">
  <button onclick="myFunctionthree()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> MICROPROCESSORS AND MICROCONTROLLERS</button>
...
<div class="dropdown">
  <button onclick="myFunctionfour()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">THEORY OF COMPUTATION</button>
...
<div class="dropdown">
  <button onclick="myFunctionfive()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> OBJECT ORIENTED ANALYSIS AND DESIGN</button>
...
<div class="dropdown">
  <button onclick="myFunctionlab()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">MICROPROCESSORS AND MICROCONTROLLERS LABORATORY</button>
...
<div class="dropdown">
  <button onclick="myFunctionlab1()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">OBJECT ORIENTED ANALYSIS AND DESIGN LABORATORY </button>
...
<div class="dropdown">
  <button onclick="myFunctionlab2()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> NETWORKS LABORATORY </button>
