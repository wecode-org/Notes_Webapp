...
<div class="dropdown">
  <button onclick="myFunction()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">PRINCIPLES OF MANAGEMENT</button>
...
<div class="dropdown">
  <button onclick="myFunctiontwo()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">CRYPTOGRAPHY AND NETWORK SECURITY </button>
...
<div class="dropdown">
  <button onclick="myFunctionthree()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> CLOUD COMPUTING</button>
...
<div class="dropdown">
  <button onclick="myFunctionfour()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">HUMAN COMPUTER INTERACTION</button>
...
<div class="dropdown">
  <button onclick="myFunctionfive()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">BIG DATA ANALYSIS</button>
...
<div class="dropdown">
  <button onclick="myFunctionsix()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">MEDICAL ELECTRONICS</button>
...
<div class="dropdown">
  <button onclick="myFunctionlab()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">CLOUD COMPUTING LABORATORY</button>
...
<div class="dropdown">
  <button onclick="myFunctionlab1()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">SECURITY LABORATORY </button>
