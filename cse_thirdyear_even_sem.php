...
<div class="dropdown">
  <button onclick="myFunction()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> INTERNET PROGRAMMING </button>
...
<div class="dropdown">
  <button onclick="myFunctiontwo()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">  ARTIFICIAL INTELLIGENCE </button>
...
<div class="dropdown">
  <button onclick="myFunctionthree()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">MOBILE COMPUTING</button>
...
<div class="dropdown">
  <button onclick="myFunctionfour()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">COMPILER DESIGN</button>
...
<div class="dropdown">
  <button onclick="myFunctionfive()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">DISTRIBUTED SYSTEMS</button>
...
<div class="dropdown">
  <button onclick="myFunctionlab()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> INTERNET PROGRAMMING LABORATORY</button>
...
<div class="dropdown">
  <button onclick="myFunctionlab1()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">MOBILE APPLICATION DEVELOPMENT LABORATORY</button>
