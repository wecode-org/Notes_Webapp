...
<div class="dropdown">
  <button onclick="myFunction()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">DISCRETE MATHEMATICS</button>
...
<div class="dropdown">
  <button onclick="myFunctiontwo()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">DIGITAL PRINCIPLES AND SYSTEM DESIGN </button>
...
<div class="dropdown">
  <button onclick="myFunctionthree()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> DATA STRUCTURES</button>
...
<div class="dropdown">
  <button onclick="myFunctionfour()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">OBJECT ORIENTED PROGRAMMING</button>
...
<div class="dropdown">
  <button onclick="myFunctionfive()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">COMMUNICATION ENGINEERING </button>
...
<div class="dropdown">
  <button onclick="myFunctionlab()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> DATA STRUCTURES LABORATORY </button>
...
<div class="dropdown">
  <button onclick="myFunctionlab2()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> DIGITAL SYSTEMS LABORATORY </button>
