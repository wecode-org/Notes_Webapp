...
<div class="dropdown">
  <button onclick="myFunction()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">PROFESSIONAL ELECTIVE V</button>
...
<div class="dropdown">
  <button onclick="myFunctiontwo()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;">PROFESSIONAL ELECTIVE VI</button>
...
<div class="dropdown">
  <button onclick="myFunctionlab2()" class="dropbtn" style="width: 300px !important; min-width: 100px; max-width: 500px;"> project work</button>
