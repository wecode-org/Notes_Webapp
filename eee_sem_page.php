...
<div class="dropdown">
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="cse_secondyear_odd_sem.php">odd sem</a>
    <a href="cse_secondyear_even_sem.php">Even sem</a>
...
<div class="dropdown">
  ...
  <div id="myDropdownone" class="dropdown-content">
    <a href="cse_thirdyear_odd_sem.php">odd sem</a>
    <a href="cse_thirdyear_even_sem.php">Even sem</a>
...
<div class="dropdown">
  ...
  <div id="myDropdowntwo" class="dropdown-content">
    <a href="cse_finalyear_odd_sem.php">odd sem</a>
    <a href="cse_finalyear_even_sem.php">Even sem</a>
